  ...
  <div class="row">
     ...
     <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
       <div class="form-group">
           ...
           <input type="text" name="codigo" required value="{{old('codigo')}}" class="form-control" placeholder="Código do artigo...">
       </div>
     </div>
     <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
       <div class="form-group">
     ...
     <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
       <div class="form-group">
           ...
           <input type="text" name="descricao" value="{{old('descricao')}}" class="form-control" placeholder="Descriçao do Estoque..">
        </div>
      </div>  
